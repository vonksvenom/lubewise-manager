...
const generateOrdensServico = () => {
  const ordens = [...baseWorkOrders]; // Include base orders (Corretiva and Proativa)
      ...
      equipamento.maintenancePlans.forEach(plan => {
        ...
        while (currentDate <= endDate) {
          ordens.push({
            ...
            dataExecucao: currentDate.toISOString(), // Set execution date same as start date
            tecnicoId: null,
          ...
          switch (plan.recorrencia) {
            ...
            case "fivemonths":
              ...
              break;
            Entendo suas solicitações. Vamos implementar as mudanças necessárias para atender a todos os pontos mencionados. Começaremos atualizando o formulário de ordens de serviço, melhorando o logo e ajustando a geração de ordens de serviço.
