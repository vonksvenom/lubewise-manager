  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'neo-xl': '16px 16px 32px rgba(0, 0, 0, 0.3), -16px -16px 32px rgba(255, 255, 255, 0.1)',
        'neo-3d': '0 20px 40px rgba(var(--primary-rgb), 0.2)',
        'neo-3d-hover': '0 30px 50px rgba(var(--primary-rgb), 0.3)',
      },
    },
  },
